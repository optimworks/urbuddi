...
public class LoginPage extends BasePage {
	...
	String InvalidErrorMsg = "css=.err-msg-display";
	String LogoutButton = "css=button[class*='logout']";
	...
	public void verifyIsInvalidCredTextDisplayed() {
		elementVisible(InvalidErrorMsg);
		verifyElementContainsText(InvalidErrorMsg, "Invalid credentials");
	}
